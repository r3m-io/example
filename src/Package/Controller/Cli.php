...
namespace Package\R3m\Io\Example\Controller;
...
class Cli extends Controller {
    ...
    const INFO = [
        '{{binary()}} r3m_io/example                 | Example options',
        '{{binary()}} r3m_io/example setup           | Example setup',
        '{{binary()}} r3m_io/example update          | Example update',
    ];
